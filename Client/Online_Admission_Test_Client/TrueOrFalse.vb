...
Public Class TrueOrFalse
    ...
    Private Sub Next_BTN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Next_BTN.Click
        answer = ComboBox1.Text.ToLower
        If answer = NewDataTable.Rows(i)("answer").ToString.ToLower Then
            score += 1
    ...
    Private Sub TrueOrFalse_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub SelectRandomQuestion()
        ...
        End With
        With NewCmd
            .CommandText = "SELECT * FROM trueorfalse WHERE subject = '" & Subject & "' LIMIT 5"
            .Connection = NewCon
        End With
        With NewAdapter
