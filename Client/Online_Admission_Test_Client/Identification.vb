...
Public Class Identification
    ...
    Private Sub Next_BTN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Next_BTN.Click
        ...
        If answer = NewDataTable.Rows(i)("answer1").ToString.ToLower Or answer = NewDataTable.Rows(i)("answer2").ToString.ToLower Or answer = NewDataTable.Rows(i)("answer3").ToString.ToLower Then
            score += 1
    ...
    Private Sub SelectRandomQuestion()
        ...
        End With
        With NewCmd
            .CommandText = "SELECT * FROM identification WHERE subject = '" & Subject & "' LIMIT 5"
            .Connection = NewCon
        End With
        With NewAdapter
