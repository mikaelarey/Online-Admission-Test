Public Class TrueOrFalse
    ...
    Private Sub Submit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Submit.Click
        ...
        Else
            ...
            End With
            With cmd
                .CommandText = "INSERT INTO trueorfalse(question, answer, subject) VALUES('" & QuestionTB.Text & "', '" & Answer.Text.ToLower & "', '" & Subject.Text.ToLower & "')"
                .Connection = con
                Try
                    .ExecuteNonQuery()
                    MessageBox.Show("New Question has been successfully inserted to the true or false type of question with the subject " & Subject.Text, "Question Inserted Successfully", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Catch ex As Exception
