...
Public Class EditMatchingType
    ...
    Sub display()
        ...
        Dim sqlQuery As String = "SELECT * FROM online_admission_test.matchingtype WHERE subject = '" & Subject.Text & "'"
    ...
    Sub SearchFunction()
        ListView1.Items.Clear()
        Dim sqlQuery As String = "SELECT * FROM online_admission_test.matchingtype WHERE subject = '" & Subject.Text & "' and (question LIKE '%" & Search_TB.Text & "%' or answer LIKE '%" & Search_TB.Text & "%')"
        Dim adpater As New MySqlDataAdapter
        Dim cmd As New MySqlCommand
        Dim table As New DataTable
        Dim i As Integer
    ...
    Private Sub Edit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Edit.Click
        ...
        Else
            ...
            Else
                ...
                Else
                    Dim cmd As New MySqlCommand
                    cmd.CommandText = "UPDATE online_admission_test.matchingtype SET question = '" & Question.Text & "', answer  = '" & A.Text & "' WHERE id = '" & ItemId.Text & "'"
                    cmd.Connection = con
                    cmd.ExecuteNonQuery()
    ...
    Private Sub Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Delete.Click
        Dim result As MsgBoxResult = MessageBox.Show("Do you really want to delete this item?" & vbCrLf & vbCrLf & "ID: " & ItemId.Text & vbCrLf & vbCrLf & "Question: " & Question.Text & vbCrLf & vbCrLf & "Answer:" & vbCrLf & A.Text, "Confirm delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        If result = MsgBoxResult.Yes Then
            Dim cmd As New MySqlCommand
            cmd.Connection = con
            cmd.CommandText = "DELETE FROM online_admission_test.matchingtype WHERE id = '" & ItemId.Text & "'"
            Try
                cmd.ExecuteNonQuery()
